...
import { Box, Card, Container, ListItemIcon, MenuItem, MenuList, Pagination, Stack, Typography, useTheme, Button } from '@mui/material'
...
const Home = () => {
    ...
    useEffect(() => {
        dispatch(jobLoadAction(page, keyword, cat, locationFilter));
    }, [page, keyword, cat, locationFilter]);
