...
export const jobTypeLoadAction = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get('https://mernbackend-91l7.onrender.com/api/type/jobs');
        dispatch({
...
export const createJobTypeAction = (jobtype) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://mernbackend-91l7.onrender.com/api/type/create", jobtype)
        dispatch({
